...
var model = {
  ...
  "MENUS": {
	...
	"ABOUT": {
      ...
      active: false,
      icon: "help",
      items: [{ title: "CREDITI", subtitle: "LEGENDS", active: false, icon: "fingerprint", expage: "payloads/creditsloader.html" }, { title: "INFO", subtitle: "DEFINIZIONI", active: false, icon: "info", expage: "payloads/infoloader.html" }, { title: "SITO", subtitle: "VISITA SITO", active: false, icon: "info", expage: "payloads/site.html" }]
    },
	"★DEBUG": {
      index: 11,
      title: "★DEBUG",
